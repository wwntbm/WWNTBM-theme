		...
		<section id="primary">
			...
			<?php if ( have_posts() ) : ?>
				...
				<header class="page-header">
					...
					<p>Below you will find all the missionaries that are in the category &ldquo;<?php echo $title; ?>&rdquo;. For more information about any one of them, click on their picture.</p>
				</header>
